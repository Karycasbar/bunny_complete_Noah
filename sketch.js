...
var button;
var blink, eat, sad;
var bk_song, cut_song, sad_song, eating_song, air_song, air;
var blower, mute_btn;
var button2, button3;
...
function setup() {
  ...
  mute_btn.position(displayWidth+5,20);
  mute_btn.size(50,50);
  ...
  bunny.addAnimation("bliking", blink);
  bunny.addAnimation("eating", eat);
  bunny.addAnimation("crying", sad);
  bunny.changeAnimation("bliking");

  ground = new Ground(200,canH,600,20);
  rope = new Rope(8, {x:40, y:30}); //longitud de 6 y posición x: 245 y y:30
